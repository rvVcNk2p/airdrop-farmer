...
// Huge thanks to the author of this snippet:
	...
	(
		...
		return (
			...
			>
				<div
					className={cn(
						'group rounded-md border border-input px-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
						className,
					)}
				>
						...
						{selected.map((option) => {
							return (
								...
								>
									...
									>
										<XMarkIcon className="h-3 w-3 shrink-0 text-muted-foreground hover:text-foreground" />
									</button>
								</Badge>
							)
						})}
